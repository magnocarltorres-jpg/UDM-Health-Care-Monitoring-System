...
function EditNurse({
  ...
  const [staffId, setStaffId] = useState(nurse?.staffId || "");
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-800">Edit Nurse</h1>

          <p className="mt-1 text-slate-500">Update the nurse's information.</p>
        </div>
